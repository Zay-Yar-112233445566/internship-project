...
<c:import url="../../layout/header.jsp">
	<c:param name="title" value="Bus List Page" />
</c:import>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="managerForm">
							     Home</a>
							</li>
					...
					<div class="table-wrapper">
						<div class="table-title">
							...
							<div class="col-sm-7 modalbox">
									<form:form modelAttribute="bus" action="availableBusForm" method="post" >
										<div class="row mb-3">										   
											<div class="col-md-6">	
											...
											<div class="col-md-2">										    
											         <button type="submit" class="form-control"
											         style="width: 100%;"><a href="allBusListForm">All</a>
											         </button>  
											</div>
											<div class="col-md-2">										    
											         <button type="submit" class="form-control"
											         style="width: 100%;"><a href="/NgweOoBusRouteControlManagementSystem/busForm">Add</a>
											         </button>  
											</div>
										</div>
									</form:form>
							...
							<tbody>
								...
								<c:forEach var="bus" items="${busList}">
									<tr align="center">
										...
										<td><a href="editBus/${bus.busId}" class="settings"
											title="Edit"> <i class="fa fa-edit"></i>
										</a> <a href="deletBus/${bus.busId}" class="delete" title="Delete"><i
