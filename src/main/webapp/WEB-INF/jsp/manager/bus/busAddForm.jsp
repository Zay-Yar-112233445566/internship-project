...
<c:import url="../../layout/header.jsp">
	<c:param name="title" value="Bus  Register Page" />
</c:import>
		...
		<div class="row">
				...
				<div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="busListForm">Bus
									 List</a></li>
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body">
						<div class="row mb-3">
							<h5 class="card-title" align="center">Bus Register Form</h5>
						</div>
						<form:form class="row g-3"
							action="/NgweOoBusRouteControlManagementSystem/saveBus" method="post"
							modelAttribute="bus">
							<div class="row mb-3">
								<label for="busTypeName" class="col-sm-4 col-form-label">Bus
									Type Name</label>
								<div class="col-sm-8">
									<form:select class="form-control" path="busTypeId"
										required="true">
										<c:forEach var="busType" items="${busTypeList}">
											<form:option value="${busType.busTypeId}"
												label="${busType.busTypeName}" />
										</c:forEach>
									</form:select>
								</div>
							</div>
