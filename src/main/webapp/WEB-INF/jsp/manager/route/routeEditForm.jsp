...
<c:import url="../../layout/header.jsp">
	<c:param name="title" value="Route Edit Page" />
</c:import>
		...
		<div class="row">
		    ...
		    <div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="/NgweOoBusRouteControlManagementSystem/routeListForm">Route List</a></li>
			...
			<div class="col-md-8">				
				<div class="card">
					<div class="card-body">
					   <div  class="row mb-3">
						<h5 class="card-title" align="center">Route Update Form</h5>
						</div>
						<form:form class="row g-3"
							action="/NgweOoBusRouteControlManagementSystem/editsaveRoute" method="post"
							modelAttribute="route">
							<div class="row mb-3">
								<label for="routeId" class="col-sm-4 col-form-label">Route
									Id</label>
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText"
										path="routeId" value="${route.routeId }"  required="true" readonly="true"/>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText"
										path="departurePoint" value="${route.departurePoint }"  required="true"/>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText"
										path="destinationPoint" value="${route.destinationPoint }"  required="true"/>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<form:input type="number" class="form-control" id="inputText"
										path="timeRequired" value="${route.timeRequired }" required="true" />
								</div>
							</div>
							<div class="row mb-3">
								<label for="fare" class="col-sm-4 col-form-label">Fare </label>
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText" path="fare"
										value="${route.fare }" required="true"/>
								</div>
							</div>
							<div class="row mb-3 text-center">
								<div class="col-md-6">
									<a href="/NgweOoBusRouteControlManagementSystem/routeListForm">
									    <button type="button" class="btn modalbutton btn-primary"
