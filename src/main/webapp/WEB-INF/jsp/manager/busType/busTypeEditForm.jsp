...
<c:import url="../../layout/header.jsp">
	<c:param name="title" value="Bus Type Page" />
</c:import>
		...
		<div class="row">
				...
				<div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="/NgweOoBusRouteControlManagementSystem/busTypeListForm">Bus Type
									List</a></li>
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body">
					   <div  class="row mb-3">
						<h5 class="card-title" align="center">Bus Type Update Form</h5>
			       	</div>
						<form:form class="row g-3"
							action="/NgweOoBusRouteControlManagementSystem/editsaveBusType"
							method="post">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText"
										path="busTypeId" value="${busType.busTypeId}" readonly="true" />
								</div>
							</div>
							
							<div class="row mb-3">
								<label for="busTypeName" class="col-sm-4 col-form-label">Bus
									Type Name</label>
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText"
										path="busTypeName" value="${busType.busTypeName }" />
								</div>
							</div>
							<div class="row mb-3">
								<label for="inputEmail3" class="col-sm-4 col-form-label">Number
									Of Seats</label>
								<div class="col-sm-8">
									<form:input class="form-control" id="numberOfSeats"
										path="numberOfSeats" value="${busType.numberOfSeats}" />
								</div>
							</div>
							<div class="row mb-3 text-center">
								<div class="col-sm-6">
									<a href="/NgweOoBusRouteControlManagementSystem/busTypeListForm"><button type="button" class="btn btn-primary"
