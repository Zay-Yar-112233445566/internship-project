				...
				<div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="busTypeListForm">Bus
									Type List</a></li>
						</ol>
					</nav>
				</div>
					...
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-5">
									<h2>
										Bus Type <b>Management</b>
									</h2>
								</div>
								<div class="col-sm-7 modalbox">
									<!-- Disabled Backdrop Modal -->
									<a href="busTypeForm" class="btn btn-primary"><i
										class="fas fa-plus">&#xE24D;</i> <span>Add New
											Bus Type</span></a>
								</div>
							</div>
						</div>
							...
							<tbody>
								...
								<c:forEach var="busType" items="${busTypeList}">
									<tr align="center">
										...
										<td>${busType.numberOfSeats}</td>
										<td><a href="editBusType/${busType.busTypeId}"
											class="settings" title="Edit"> <i class="fa fa-edit"></i>
										</a> <a href="deletBusType/${busType.busTypeId}" class="delete"
