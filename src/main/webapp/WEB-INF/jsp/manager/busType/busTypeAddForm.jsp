...
<c:import url="../../layout/header.jsp">
	<c:param name="title" value="Bus Type Register Page" />
</c:import>
		...
		<div class="row">
				...
				<div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="busTypeListForm">Bus Type
									List</a></li>
							<li class="breadcrumb-item active">Bus Type Add</li>
						</ol>
					</nav>
				</div>
			</div>
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body">
					   <div  class="row mb-3">
						<h5 class="card-title" align="center">Bus Type Register Form</h5>
						</div>
						<form:form class="row g-3"
							action="/NgweOoBusRouteControlManagementSystem/saveBusType" method="post"
							modelAttribute="busType">
							<div class="row mb-3">
								<label for="busTypeName" class="col-sm-4 col-form-label">Bus Type
									Name</label>
								<div class="col-sm-8">
							...
							<div class="row mb-3">
								<label for="numberOfSeats" class="col-sm-4 col-form-label">Number Of Seats
									 </label>
								<div class="col-sm-8">
							...
							<div class="row mb-3 text-center">
								<div class="col-md-6">
									<a href="/NgweOoBusRouteControlManagementSystem/busTypeListForm"><button type="button" class="btn modalbutton btn-primary"
