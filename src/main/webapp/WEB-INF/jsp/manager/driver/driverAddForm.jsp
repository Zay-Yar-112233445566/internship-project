...
<c:import url="../../layout/header.jsp">
	<c:param name="title" value="Driver Register Page" />
</c:import>
		...
		<div class="row">
				...
				<div class="pagetitle">
					...
					<nav>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="driverListForm">Driver
									List</a></li>
						</ol>
					</nav>
				</div>
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body">
					   <div  class="row mb-3">
					   	<h5 class="card-title" align="center">Driver Register Form</h5>
					   </div>				
						<!-- Router Add Form Start -->
						<form:form class="row g-3"
							action="/NgweOoBusRouteControlManagementSystem/saveDriver" method="post"
							modelAttribute="driver">
							<div class="row mb-3">
								<label for="driverName" class="col-sm-4 col-form-label">Driver
									Name</label>
								<div class="col-sm-8">
									<form:input class="form-control" id="inputText"
										path="driverName" value="${driver.driverName }"
										required="true" />
								</div>
							</div>
							<div class="row mb-3">
								<label for="driverPhone" class="col-sm-4 col-form-label">Phone
									 </label>
								<div class="col-sm-8">
									<form:input type="number" class="form-control" id="inputText"
										path="driverPhone" value="${driver.driverPhone}"
										required="true" />
								</div>
							</div>
							<div class="row mb-3">
								<label for="driverEmail" class="col-sm-4 col-form-label">Email
									</label>
								<div class="col-sm-8">
									<form:input type="email" class="form-control" id="inputText"
										path="driverEmail" value="${driver.driverEmail }"
										required="true" />
								</div>
							</div>
							<div class="row mb-3">
								<label for="driverAddress" class="col-sm-4 col-form-label">Address
								</label>
								<div class="col-sm-8">
								...
								<div class="row mb-3">
								<label for=driverPassword class="col-sm-4 col-form-label">Password
								</label>
								<div class="col-sm-8">
									<form:input type="password" class="form-control"
										path="driverPassword" placeholder="Password" />
								</div>
							</div>
							
							<div class="row mb-3 text-center">
								<div class="col-md-6">
									<a href="/NgweOoBusRouteControlManagementSystem/driverListForm"><button type="button" class="btn modalbutton btn-primary"
